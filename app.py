...
if choice == "Home":
    ...
    with col1:
        st.image("Iban.png", caption='Johnvic Ivan R.Añora\n ajr1105@dlsud.edu.ph ')
    with col2:
        st.image("WIL.jpg", caption="Mark William S. Aytin\n ams1004@dlsud.edu.ph")
    with col3:
        st.image("PAPA.jpg",caption="Dranel Allen Papa\n pdm0880@dlsud.edu.ph")
